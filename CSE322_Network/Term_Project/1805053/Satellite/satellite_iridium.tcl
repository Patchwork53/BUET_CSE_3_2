...
set tcp_sink0 [new Agent/TCPSink/Sack1]
$ns_ attach-agent $n101 $tcp_sink0

set tcp_sink1  [new Agent/TCPSink/Sack1]
$ns_ attach-agent $n201 $tcp_sink1

$ns_ connect $tcp0 $tcp_sink0
$ns_ connect $tcp1 $tcp_sink1
...
$ns_ at 0 "$tcp0 select_ca cubic"
$ns_ at 0 "$tcp1 select_ca cubic"
